...
const messages = {
  ...
  resources: {
    ...
    competences: {
      ...
      addOne: "Vorresti aggiungerne una?",
      singular: "competenza",
      plural: "competenze",
    },
    externalActivities: {
    ...
    learningScenarios: {
      ...
      singular: "scenario",
      plural: "scenari",
      noScenarioLearners: "Nessuno studente è associato a questo scenario",
      addLearners: "Vorresti aggiungerne qualcuno?",
      noDomainLearners: "Nessuno studente presente nel dominio",
    },
    modules: {
      back: "Moduli",
      menu: "Moduli",
