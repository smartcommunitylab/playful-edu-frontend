...
// node_modules/@smartcommunitylab/ra-language-italian/dist/esm/index.js
var italianMessages = {
  ra: {
    action: {
    ...
    page: {
      ...
      error: "Qualcosa \xE8 andato storto",
      list: "%{name}",
      loading: "Caricamento",
    ...
    input: {
      file: {
        upload_several: "Rilascia i file per caricare, o clicca per selezionare.",
        upload_single: "Rilascia un file per caricare, o clicca per selezionare."
      },
      image: {
        upload_several: "Trascina le immagini per caricarle, o clicca per selezionare.",
        upload_single: "Trascina una immagine per caricarla, o clicca per selezionare."
      },
      references: {
        all_missing: "Impossibile trovare i dati referenziati",
        many_missing: "Almeno uno dei dati referenziati sembra non essere disponibile.",
        single_missing: "Il dato referenziato sembra non essere pi\xF9 disponibile."
      },
      password: {
    ...
    message: {
      ...
      auth_error: "Si \xE8 verificato un errore durante la convalida del token di autenticazione.",
      ...
      details: "Dettagli",
      error: "Si \xE8 verificato un errore del client e non \xE8 stato possibile completare la tua richiesta.",
      invalid_form: "Il modulo non \xE8 valido. Si prega di verificare la presenza di errori",
      loading: "La pagina si sta caricando, solo un momento per favore",
      no: "No",
      not_found: "O hai digitato un URL sbagliato o hai seguito un link non valido.",
      yes: "Si",
      unsaved_changes: "Alcune delle tue modifiche non sono state salvate. Sei sicuro di volerle ignorare?"
    },
    navigation: {
      no_results: "Nessun risultato trovato",
      no_more_results: "Il numero di pagina %{page} \xE8 fuori dai limiti. Prova la pagina precedente.",
      page_out_of_boundaries: "La pagina numero %{page} \xE8 fuori dai limiti",
      ...
      partial_page_range_info: "%{offsetBegin}-%{offsetEnd} di pi\xF9 di %{offsetEnd}",
    ...
    notification: {
      ...
      i18n_error: "Impossibile caricare le traduzioni per il linguaggio richiesto",
      canceled: "Azione cancellata",
      logged_out: "La sessione \xE8 terminata, prego riconnettersi.",
    ...
    saved_queries: {
      ...
      remove_message: "Sei sicuro di voler rimuovere questo elemento dalla lista di ricerche salvate?",
...
var esm_default = italianMessages;
export {
  esm_default as default
};
//# sourceMappingURL=@smartcommunitylab_ra-language-italian.js.map
