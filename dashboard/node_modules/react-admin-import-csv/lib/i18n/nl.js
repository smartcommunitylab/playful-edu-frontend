...
exports.default = {
    csv: {
        buttonMain: {
            ...
            emptyResource: "De 'resource' property was leeg, zijn de {...props} meegegeven aan de ImportButton?",
        },
        parsing: {
        ...
        dialogCommon: {
            ...
            conflictCount: "De resource <strong>%{resource}</strong> heeft <strong>%{conflictingCount}</strong> conflicterende ids",
            buttons: {
                cancel: "Annuleren",
            }
        },
