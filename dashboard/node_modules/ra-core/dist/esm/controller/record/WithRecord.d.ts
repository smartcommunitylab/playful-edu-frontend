 ...
 * );
 */
export declare const WithRecord: <RecordType extends RaRecord<import("../../types").Identifier>>({ render, }: WithRecordProps<RecordType>) => ReactElement<any, string | import("react").JSXElementConstructor<any>>;
